...
class RegisterTest(TestCase):
    ...
    def test_invalid_token_search_flight(self):
        data = {
            "email": "test@test.com",
            "password": "test",
            "username": "test"
    ...
    def test_missing_search_flight(self):
        data = {
            "email": "test@test.com",
            "password": "test",
            "username": "test"
        ...
        response = self.client.get("/v1/flight/search", json=data,
                                   headers=headers)
        self.assertEquals(response.json, {'message': 'Does not exists.'})
        self.assert404(response)

    def test_search_flight_after_logout(self):
        data = {
            "email": "test@test.com",
            "password": "test",
            "username": "test"
